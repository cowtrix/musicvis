...
public static class IcoSphereUtility
{
    ...
    public static Mesh CreateIsoSphere(Mesh mesh, float radius, int recursionLevel)
    {
        if (mesh == null)
        {
            mesh = new Mesh();
