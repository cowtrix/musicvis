	...
	public class SimplexNodeWrapper<T> : FlowNode where T:SimplexNode {
		...
		protected override UnityEditor.GenericMenu OnContextMenu(UnityEditor.GenericMenu menu){
			...
			if (type.IsGenericType){
				menu = EditorUtils.GetPreferedTypesSelectionMenu(type.GetGenericTypeDefinition(), (t)=>{ this.ReplaceWith( typeof(SimplexNodeWrapper<>).MakeGenericType(t) ); }, menu, "Change T Type");
			}
