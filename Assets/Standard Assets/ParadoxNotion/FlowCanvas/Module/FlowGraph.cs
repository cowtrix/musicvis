...
namespace FlowCanvas{
	...
	abstract public class FlowGraph : Graph {
		...
		protected override UnityEditor.GenericMenu OnCanvasContextMenu(UnityEditor.GenericMenu menu, Vector2 mousePos){
			menu = this.AppendSimplexNodesMenu(menu, "", mousePos, null, null);
			menu = this.AppedVariableNodesMenu(menu, "Variables", mousePos, null, null);
			menu = this.AppendAllReflectionNodesMenu(menu, "Reflected", mousePos, null, null);
