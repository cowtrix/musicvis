...
#if UNITY_2017_2_OR_NEWER
            static void PlayModeChanged(UnityEditor.PlayModeStateChange state){ JSONSerializer.applicationPlaying = Application.isPlaying && UnityEditor.EditorApplication.isPlayingOrWillChangePlaymode; }
#else
            static void PlayModeChanged(){ JSONSerializer.applicationPlaying = Application.isPlaying && UnityEditor.EditorApplication.isPlayingOrWillChangePlaymode; }
#endif
        }
#endif
