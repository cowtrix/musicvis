...
*/
        ...
        private fsResult InternalSerialize_2_Inheritance(Type storageType, Type overrideConverterType, object instance, out fsData data) {
            ...
            if (storageType != instance.GetType() &&
                ...
                //PARADOXNOTION ADDITION (using ToString() instead of FullName, provides better naming for generics)
                data.AsDictionary[Key_InstanceType] = new fsData(instance.GetType().ToString());
            }
