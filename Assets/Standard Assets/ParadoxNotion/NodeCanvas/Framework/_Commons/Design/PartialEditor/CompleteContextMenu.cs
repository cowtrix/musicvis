	...
	public class CompleteContextMenu : PopupWindowContent {
		...
		public override void OnGUI(Rect rect){
			...
			foreach (var childPair in currentNode.children){
				...
				//Prefix icon
				var memberInfo =  leafItem != null? node.item.userData as MemberInfo : null;
				GUI.color = memberInfo != null && icon != null && icon.name == UserTypePrefs.DEFAULT_TYPE_ICON_NAME? UserTypePrefs.GetTypeColor(memberInfo.DeclaringType) : Color.white;
