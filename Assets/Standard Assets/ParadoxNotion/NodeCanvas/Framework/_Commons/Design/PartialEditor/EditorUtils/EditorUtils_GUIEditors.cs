...
namespace ParadoxNotion.Design{
	...
	partial class EditorUtils {
		...
		public static IList ListEditor(string prefix, IList list, Type listType, object contextInstance, bool allowDerived = false){
			return ListEditor(new GUIContent(prefix), list, listType, contextInstance, allowDerived);
		}
        public static IList ListEditor(GUIContent prefix, IList list, Type listType, object contextInstance, bool allowDerived = false)
        {
            ...
            for (var i = 0; i < list.Count; i++)
            {
                ...
                list[i] = GenericField("Element " + i, list[i], list[i] == null ? argType : list[i].GetType(), null);
