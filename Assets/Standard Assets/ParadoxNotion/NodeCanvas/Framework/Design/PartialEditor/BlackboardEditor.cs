...
namespace NodeCanvas.Editor{
    ...
    public static class BlackboardEditor {
		...
		private static Dictionary<IBlackboard, ReorderingState> tempStates = new Dictionary<IBlackboard, ReorderingState>();
		...
		public static void ShowVariables(IBlackboard bb, UnityEngine.Object contextParent){
			...
			EditorUtils.ReorderableList(tempStates[bb].list, (i) =>
			{
